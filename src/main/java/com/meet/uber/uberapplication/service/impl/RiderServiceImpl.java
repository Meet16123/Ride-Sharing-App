...
import com.meet.uber.uberapplication.entities.*;
...
import com.meet.uber.uberapplication.strategies.RideStrategyManager;
...
//        TODO : Send notification to all the drivers about this ride request
    ...
    public RideDto cancelRide(Long rideId) {
        ...
        if(!rider.equals(ride.getRider())) {
            throw new RuntimeException("Rider is not authorized to cancel this ride request");
        }
    ...
    @Override
    public DriverDto rateDriver(Long rideId, Float rating) {
        Ride ride = rideService.getRideById(rideId);
        Rider rider = getCurrentRider();
        if(!rider.equals(ride.getRider())) {
    ...
    public Rider getCurrentRider() {
        ...
        return riderRepository.findByUser(user).orElseThrow(() -> new ResourceNotFoundException("Rider is not found with user id: " + user.getId()));
    }
